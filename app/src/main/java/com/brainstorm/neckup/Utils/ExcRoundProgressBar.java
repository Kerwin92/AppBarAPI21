 ...
 */
public class ExcRoundProgressBar extends View {
    /**
     * 画笔对象的引用
     */
    private Paint paint;
    ...
    public ExcRoundProgressBar(Context context) {
        this(context, null);
    }

    public ExcRoundProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public ExcRoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setRoundtColor(int roundColor) {
