...
public class ScoreRoundProgressBar extends View {
    ...
    public ScoreRoundProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public ScoreRoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(textIsDisplayable && percent != 0 && style == STROKE){
            ...
            canvas.drawText(percent + "分", centre - textWidth / 2, centre + textSize, paint); //画出进度百分比
        }
